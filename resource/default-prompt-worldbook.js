...
window.天青_default_prompt_worldbook = {
  ...
  "entries": {
    "0": {
      ...
      "keysecondary": [],
      "comment": "变量列表",
      "content": "时间.天数：{{stat_data::时间.天数}} #整数\n时间.具体时间：{{stat_data::时间.具体时间}} #以[小时,分钟]的形式显示\n时间.星期：{{stat_data::时间.星期}} #包含日一二三四五六\n地点：{{stat_data::地点}} #参照标准地点，如无则自建地点\n名气.twitter：{{stat_data::名气.twitter}} #Twitter/X 粉丝数，整数\n名气.同接：{{stat_data::名气.同接}} #最近直播同接人数，整数\n名气.专辑：{{stat_data::名气.专辑}} #每条 [专辑名称, 首发销量]；新专辑用 _.append 追加\n名气.Live：{{stat_data::名气.Live}} #每条 [地点, 参加人数]；新现场用 _.append 追加",
      "constant": true,
      "order": -1000,
      "position": 0,
      "depth": 4,
    ...
    "3": {
      ...
      "keysecondary": [],
      "comment": "立绘",
      "content": "▸ **日常立绘**（她穿便服 / 校服，日常剧情用）：\n`暧昧地打量` `比较高兴` `比心` `比耶` `不满` `得意` `飞吻` `刚睡醒或困倦` `高兴` `害羞` `红温` `假装很生气` `惊讶` `警觉或察觉` `窘迫` `流泪` `卖萌` `疲惫或无语` `祈祷` `失落` `思考` `完全胜利` `微笑` `无语` `星星眼` `羞涩` `疑问` `真的很生气` `自信` `做鬼脸` `比较开心2` `吃醋` `俏皮` `俏皮2` `撒娇` `委屈`\n\n▸ **演出 / 唱歌立绘**（她唱歌、弹吉他、上台、直播、拍 MV 时用；带 `演出服` 前缀的是穿演出服，`婚纱` 前缀的是穿婚纱）：\n`闭眼唱歌` `唱哭了` `沉醉` `弹吉他` `俏皮歌唱` `微笑弹吉他` `笑着弹吉他` `笑着歌唱` `演出服wink` `演出服不满` `演出服卖萌` `演出服吐舌` `演出服小恶魔` `演出服开心` `演出服得意` `演出服得意1` `演出服得意歌唱` `演出服微笑` `演出服思考` `演出服惊讶` `演出服惊讶2` `演出服撒娇` `演出服无语` `演出服歌唱` `演出服比心` `演出服生气` `演出服疑问` `演出服笑着歌唱` `婚纱wink` `婚纱不甘` `婚纱歌唱` `婚纱开心` `婚纱俏皮` `婚纱生气` `婚纱歌唱开心` `婚纱委屈` `婚纱无语` `婚纱无语2` `婚纱自豪`",
      "constant": true,
      "order": 202,
      "position": 0,
      "depth": 0,
